...
<div id="big_wrapper">
	...
	<section id="login_section">
		...
		<form id="admin_login_form" action="sellersessionstart.php" method="post">
			<h3>Seller Login Form</h3>
			<hr/>
			<div>
			<p>Username: <input type="text" name="username" /></p>
			<p>Password&nbsp: <input type="password" name="password" /></p>
			<p><input type="submit" id="adminsubmit" name="login" value="Login"/>
			<input type="submit" id="sellerregistration" name="signup" value="Registration"/>
			</p>
				<section>
